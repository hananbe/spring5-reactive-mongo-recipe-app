...
public class IngredientServiceImplTest {
    ...
    public void findByRecipeIdAndReceipeIdHappyPath() throws Exception {
        ...
        when(recipeReactiveRepository.findById(anyString()).blockOptional()).thenReturn(recipeOptional);
    ...
    public void testSaveRecipeCommand() throws Exception {
        ...
        when(recipeReactiveRepository.save(any()).block()).thenReturn(savedRecipe);
